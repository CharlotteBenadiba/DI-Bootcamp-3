...
-- All the customers first_name and isLoggedIn columns - even the customers those who 
...
-- Create a table named Student, with the columns : student_id SERIAL PRIMARY KEY, name 
-- NOT NULL UNIQUE, age. Make sure that the age is never bigger than 15 (Find an SQL method);
...
-- the student named John, borrowed the book Alice In Wonderland 15/02/2022
-- the student named Bob, borrowed the book To kill a mockingbird on the 03/03/2021
-- the student named Lera, borrowed the book Alice In Wonderland 23/05/2021
-- the student named Bob, borrowed the book Harry Potter 12/08/2021
