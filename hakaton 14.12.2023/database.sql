...
-- DELETE FROM famous_persons
-- WHERE ctid NOT IN (
--     SELECT MIN(ctid)
--     FROM famous_persons
--     GROUP BY city_id, first_name, last_name, years_of_life, brief_biography
-- );

-- -- Удаление существующего внешнего ключа
-- ALTER TABLE famous_persons
-- DROP CONSTRAINT IF EXISTS city_id;

-- Добавление нового внешнего ключа с опцией ON DELETE CASCADE
-- ALTER TABLE famous_persons
-- ADD CONSTRAINT city_id
-- FOREIGN KEY (city_id) REFERENCES cities(city_id) ON DELETE CASCADE;

-- SELECT * FROM famous_persons WHERE city_id = 12;
-- SELECT famous_persons.*, cities.city
-- FROM famous_persons
-- JOIN cities ON famous_persons.city_id = cities.city_id
...
-- SELECT attractions.*, cities.city
-- FROM attractions
